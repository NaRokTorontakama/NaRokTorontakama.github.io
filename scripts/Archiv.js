...
for (let i = 0; i < fullLines; i++) {
  if (window.innerWidth > 480) {
    newMain += `<div class="photoContainer" style='background-image: url("../AllPageDesign/Lines/${Math.floor(
      Math.random() * 11 + 1
    )}.png")' >`;
  } else {
...
if (oddPolaroids !== 0) {
  ...
  newMain += `<div class="line" >
     <div class="photoContainer" style='background-image: url("../AllPageDesign/Lines/${Math.floor(
       Math.random() * 11 + 1
     )}.png")' >
            ${polaroids}
     </div>
